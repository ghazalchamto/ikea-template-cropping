...
class ValidationConfig:
    ...
    # ── Region-level decision (used by region_aggregator) ────────────────────
    # Per-region pass/fail threshold applied to RegionScore.combined when a
    # region's JSON config does not override it via "threshold". Used by
    # src/core/region_aggregator.py only.
    region_default_threshold: float = 0.85
